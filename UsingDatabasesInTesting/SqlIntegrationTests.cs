...
namespace UsingDatabasesInTesting
{
	...
	public class SqlIntegrationTests
	{
		...
		public void VerifyInventoryIsUpdated()
		{
			...
			DataTable initialInventoryDt = Utilities.GetQuantityOfProduct(productId, _connectionString);
			...
			int code = Utilities.UpdateQuantityOfProduct(productId, expectedQuantity, _connectionString);
			...
			DataTable updatedInventoryDt = Utilities.GetQuantityOfProduct(productId, _connectionString);
		...
		public void VerifyApiIsGettingInformationCorrectly()
		{
			...
			DataTable dbInventoryDt = Utilities.GetQuantityOfProduct(productId, _connectionString);
